...
func setupAWS(ctx context.Context, flags *App) (*App, func(), error) {
...
// command-line flags.
func awsBucket(ctx context.Context, cp awsclient.ConfigProvider, a *App) (*blob.Bucket, error) {
...
func awsSQLParams(a *App) *rdsmysql.Params {
...
func awsMOTDVar(ctx context.Context, sess awsclient.ConfigProvider, a *App) (*runtimevar.Variable, error) {
