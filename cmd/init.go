...
func initializeProject(project **runtime.Runtime) {
...
func createMainFile(project *runtime.Runtime) {
...
func createRootCmdFile(project **runtime.Runtime) {
